...
public abstract class StringUtils {
     ...
     *  StringUtils.replaceEach("abcde", new String[]{"ab", "d"}, new String[]{"d", "t"}, false) =
     *  "dcte"
     *  StringUtils.replaceEach("abcde", new String[]{"ab", "d"}, new String[]{"d", "t"}, true) =
     *  "tcte"
     *  StringUtils.replaceEach("abcde", new String[]{"ab", "d"}, new String[]{"d", "ab"}, true) =
     *  IllegalArgumentException
     *  StringUtils.replaceEach("abcde", new String[]{"ab", "d"}, new String[]{"d", "ab"}, false)
     *  = "dcabe"
     * </pre>
     *
     * @param text            text to search and replace in, no-op if null
     ...
     * @return the text with any replacements processed, <code>null</code> if
     * null String input
     * @throws IllegalArgumentException  if the search is repeating and there is an endless loop
     * due
     ...
     *
     * @param str        the String to check, may be null
     * @param defaultStr the default String to return if the input is <code>null</code>
     *                   , may be null
    ...
    public static String hidenMiddlePhone(String phone) {
