package com.gzzhe.zhhwlkj.baseperject.pullLoadMoreRecyclerView;
...
import com.gzzhe.zhhwlkj.baseperject.customview.FullyLinearLayoutManager;
...
public class PullLoadMoreRecyclerView extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        mSwipeRefreshLayout.setColorSchemeResources(android.R.color.holo_green_dark, android.R
                .color.holo_blue_dark, android.R.color.holo_orange_dark);
    ...
    public void setLinearLayout(final boolean supportScroll) {
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(mContext) {
            @Override
